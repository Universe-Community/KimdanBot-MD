...
text6: `💞 *¡FLECHAZO BL!* 💞 El hilo rojo del destino enlazó a`,
text7: `y ahora sus corazones laten al mismo ritmo. ¡Que viva el amor! 💜`, 
text8: `💞 *¡FLECHAZO CORRESPONDIDO!* 💞`, 
text9: `los tres juntos harían un trío de amistad ideal 😳😏`, 
...
text15: `- Esta pareja está de luna de miel ✨😍❤️`, 
...
//nsfw.js
const nsfw = {
text: `💜 Este bot es de temática BL/Yaoi y no incluye contenido +18.`, 
text1: `💜 Explora el catálogo BL con .blsearch`, 
text2: `💜 Disfruta del universo Jinx 💜` }
